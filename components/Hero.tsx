...
import { ShieldCheck, ChevronRight, Phone, Calendar, Sparkles, ChevronLeft, Pause, Play, Layers, Film } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-0 sm:min-h-[85vh] lg:min-h-[95vh] flex items-center justify-center bg-obsidian-950 dark:bg-obsidian-950 light:bg-slate-900 transition-colors duration-300 overflow-hidden py-6 sm:py-16 lg:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 space-y-4 sm:space-y-8 text-center lg:text-left"
          >
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3">
              <motion.div 
                ...
                className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-obsidian-900/90 backdrop-blur-md border border-gold-500/40 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full shadow-xl"
              >
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gold-400 animate-pulse" />
                <span className="text-[11px] sm:text-sm font-semibold tracking-wider text-slate-100 uppercase">
                  {t('hero.badge')}
                </span>
              </motion.div>

              <div className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-gold-500/15 backdrop-blur-md border border-gold-500/50 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full shadow-md text-gold-300 font-bold text-[11px] sm:text-xs uppercase tracking-wider">
                <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-gold-400 animate-ping" />
            ...
            <motion.h1 
              ...
              className="font-serif text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-white leading-tight sm:leading-[1.25]"
            >
              {t('hero.title1')}{' '}
            ...
            <motion.div 
              ...
              className="bg-obsidian-900/90 backdrop-blur-xl border border-gold-500/30 rounded-xl p-2.5 sm:p-3.5 max-w-2xl mx-auto lg:mx-0 shadow-2xl"
            >
              <div className="text-[10px] sm:text-[11px] font-bold text-gold-400 uppercase tracking-widest mb-1.5 flex items-center justify-between">
                <div className="flex items-center">
                  <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-gold-400 mr-1.5 animate-ping" />
                  {t('hero.cinemaPartner')}
                </div>
                <span className="text-[9px] sm:text-[10px] text-slate-400 font-mono">Slide {currentSlide + 1}/{HERO_SLIDES.length}</span>
              </div>
              <div className="flex flex-wrap justify-center lg:justify-start gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-semibold">
                {['Vikram', 'Master', 'Leo', 'Kaithi', '& More'].map((movie, idx) => (
                  <motion.span 
                    key={idx}
                    whileHover={{ scale: 1.08, translateY: -2 }}
                    className="bg-obsidian-800/90 text-slate-200 px-2.5 py-1 sm:px-3 sm:py-1 rounded-lg border border-slate-700 hover:border-gold-400 transition-all flex items-center cursor-pointer shadow"
                  >
                    <Film className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1 text-gold-400 shrink-0" />
                    <span>{movie}</span>
                  </motion.span>
                ))}
              </div>
            ...
            {/* Subheading / Copy */}
            <p className="text-xs sm:text-base lg:text-lg text-slate-200 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed text-shadow-sm line-clamp-3 sm:line-clamp-none">
              {t('hero.desc')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-2.5 sm:gap-4 pt-1 sm:pt-2">
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="#booking"
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 rounded-xl text-sm sm:text-base font-bold text-obsidian-950 bg-gold-gradient hover:opacity-95 transition-all shadow-xl gold-glow tracking-wider uppercase whitespace-nowrap min-h-[44px]"
              >
              ...
              <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center sm:gap-4 w-full sm:w-auto">
                <motion.a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center px-3 py-2.5 sm:px-7 sm:py-4 rounded-xl text-xs sm:text-base font-semibold text-slate-200 bg-obsidian-900/90 backdrop-blur-md border border-gold-500/40 hover:border-gold-400 transition-all shadow-lg whitespace-nowrap min-h-[44px]"
                >
                  <span>{t('hero.exploreProjects')}</span>
                  <ChevronRight className="w-3.5 h-3.5 sm:w-5 sm:h-5 ml-1 text-gold-400 shrink-0" />
                </motion.a>
                ...
                <motion.a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center px-3 py-2.5 sm:px-6 sm:py-4 rounded-xl text-xs sm:text-base font-semibold text-emerald-400 bg-emerald-950/80 backdrop-blur-md border border-emerald-500/40 transition-all shadow-lg whitespace-nowrap min-h-[44px]"
                >
                  <Phone className="w-3.5 h-3.5 sm:w-5 sm:h-5 mr-1.5 shrink-0" />
